...
draw_sprite_ext(sprite_index,image_index,x + irandom_range(-shakeX,shakeX),y + irandom_range(-shakeY,shakeY),image_xscale,image_yscale,image_angle,image_blend,image_alpha);
