...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_BroomHatter);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_BroomHatter_Normal_Idle;
		spawnedEnemy.sprWalk = spr_BroomHatter_Normal_Walk;
		spawnedEnemy.sprHurt = spr_BroomHatter_Normal_Inhale;
		spawnedEnemy.sprHurtNormal = spr_BroomHatter_Normal_Hurt;
		break;
	}
