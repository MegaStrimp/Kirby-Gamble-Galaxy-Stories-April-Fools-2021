...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Twizzy);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Twizzy_Normal_Idle;
		spawnedEnemy.sprFly = spr_Twizzy_Normal_Fly;
		spawnedEnemy.sprHurt = spr_Twizzy_Normal_Hurt;
		break;
	}
