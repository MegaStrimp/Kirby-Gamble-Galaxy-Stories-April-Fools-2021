...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_BrontoBurt);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_BrontoBurt_Normal_Idle;
		spawnedEnemy.sprReady = spr_BrontoBurt_Normal_Ready;
		spawnedEnemy.sprWalk = spr_BrontoBurt_Normal_Walk;
		spawnedEnemy.sprFly = spr_BrontoBurt_Normal_Fly;
