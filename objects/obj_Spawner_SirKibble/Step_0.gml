...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_SirKibble);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_SirKibble_Normal_Idle;
		spawnedEnemy.sprWalk = spr_SirKibble_Normal_Walk;
		spawnedEnemy.sprReady = spr_SirKibble_Normal_Ready;
		spawnedEnemy.sprAttack = spr_SirKibble_Normal_Attack;
		spawnedEnemy.sprCatch = spr_SirKibble_Normal_Catch;
		spawnedEnemy.sprHurt = spr_SirKibble_Normal_Hurt;
		spawnedEnemy.sprHurtAir = spr_SirKibble_Normal_HurtAir;
		break;
	}
	...
	spawnedEnemy.cutterCatchTimerMax = cutterCatchTimerMax;
	spawnTimer = -1;
}