...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Search);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Search_Normal_Idle;
		spawnedEnemy.sprCharge = spr_Search_Normal_Charge;
		spawnedEnemy.sprHurt = spr_Search_Normal_Hurt;
		break;
	}
	...
	spawnedEnemy.explodeTimer = explodeTimer;
	spawnedEnemy.explodeTimerMax = explodeTimerMax;
	spawnTimer = -1;
}