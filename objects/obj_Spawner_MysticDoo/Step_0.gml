...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_MysticDoo);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_MysticDoo_Normal_Idle;
		spawnedEnemy.sprAttack = spr_MysticDoo_Normal_Attack;
		spawnedEnemy.sprHurt = spr_MysticDoo_Normal_Hurt;
		break;
	}
	...
	spawnedEnemy.orbitMax = orbitMax;
