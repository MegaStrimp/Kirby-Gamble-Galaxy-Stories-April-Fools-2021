...
{
	var spawnedEnemy = instance_create_depth(x,y,depth,obj_Tookey);
	...
	switch (character)
	{
		...
		case 0:
		spawnedEnemy.sprIdle = spr_Tookey_Normal_Idle;
		spawnedEnemy.sprFly = spr_Tookey_Normal_Fly;
		spawnedEnemy.sprHurt = spr_Tookey_Normal_Hurt;
		break;
	}
